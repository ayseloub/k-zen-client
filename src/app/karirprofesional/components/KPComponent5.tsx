...
import img from '@/shared/assets/images/sertifikasijepang.png'
import { JapanCertification } from '@/shared/models/static/CertificationValue'
        ...
        <section className='flex justify-center items-center gap-20'>
            <div className='space-y-3'>
                ...
                <h1 className='text-5xl font-semibold'>
                    Pelatihan <span className='text-Kzen-primary'>Bahasa dan<br/> Kompetensi</span>
                </h1>
                <p className='text-2xl font-extralight text-Kzen-neutral/90'>
                    Langkah awal gapai karier impianmu
                </p>
            </div>
            ...
            <div className='relative w-[45vw] rounded-3xl overflow-hidden'>
                ...
                <div className='relative z-10 h-full flex flex-col justify-center p-12 text-white'>
                    ...
                    <div className='space-y-3 mb-6'>
                        {JapanCertification.map((japan, index) => (
                            <div key={index} className='flex items-center gap-3'>
                                ...
                                />
                                <span className='text-lg'>{japan.value}</span>
                            </div>
                        ))}
                    </div>
