    ...
    <div className='relative p-10 w-full h-fit'>
        ...
        <div className=' justify-between px-10 flex'>
            <div className='relative z-10 flex flex-col h-fit space-y-2 mx-20'>
                ...
                <p className='text-4xl flex gap-2 font-semibold text-Kzen-dark'>
                    <p className='text-Kzen-primary'>Kami hadir</p> untuk mendukung
                </p>
                <p className='text-4xl flex gap-2 font-semibold text-Kzen-dark'>langkah perjalananmu</p>
            </div>
            <div className='flex'>
