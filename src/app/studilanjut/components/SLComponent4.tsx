...
import Hero from '@/shared/assets/images/campusJourney.png'
import { CampusJourneyList1, CampusJourneyList2 } from '@/shared/models/static/JourneyList'

export default function SLComponent4() {
  return (
    <div className='text-center mt-5 space-y-20 pb-20'>
        ...
        <section className='flex items-center gap-20 justify-center'>
            ...
            />
            <div>
                {CampusJourneyList1.map((journey, index) => (
        ...
        <section className='px-20'>
            <div className='flex items-center mt-36 justify-between relative'>
                ...
                {CampusJourneyList2.map((journey, index) => (
